 ...
 * Class DB
 * @package Max\Facade
 * @method static \Max\Database\Query name(string $table_name, string $alias = null) 表名设置方法
 * @method static \Max\Database\Query table(string $table_name, string $alias = null) 表名设置方法
